...
#container-wrapper{
	background: <?php if ( ! get_background_image() && ! get_background_color() ){ echo "#f5f5f5"; } ?>;
    ...
    color:<?php if($ne_buddyscholar_content_colour == ""){ ?><?php echo "#000000"; } else { ?><?php echo $ne_buddyscholar_content_colour; ?><?php } ?>;
}
...
#footer-links{
	border-top: 2px solid <?php if($ne_buddyscholar_footer_links_border_colour == ""){ ?><?php echo "#f5f5f5"; } else { ?><?php echo $ne_buddyscholar_footer_links_border_colour; ?><?php } ?>;
}
...
ol.commentlist li.even {
    ...
    color:<?php if($ne_buddyscholar_comment_meta_colour == ""){ ?><?php echo "#000000"; } else { ?><?php echo $ne_buddyscholar_comment_meta_colour; ?><?php } ?>;
}
...
li span.unread-count, tr.unread span.unread-count {
	...
	color: <?php if($ne_buddyscholar_unread_text_colour == ""){ ?><?php echo "#111111"; } else { ?><?php echo $ne_buddyscholar_unread_text_colour; ?><?php } ?>;
	font-weight: bold;
}
...
.widget-error{
    ...
    color:<?php if($ne_buddyscholar_widget_text_colour == ""){ ?><?php echo "#000000"; } else { ?><?php echo $ne_buddyscholar_widget_text_colour; ?><?php } ?>;
}
