...
<?php else : ?>
		...
		<form name="login-form" id="login-form" class="standard-form" action="<?php echo site_url( 'wp-login.php', 'login' ) ?>" method="post">
			...
			<input type="text" name="log" id="userbar_user_login" class="input" value="<?php if(isset($user_login))echo esc_attr(stripslashes($user_login)); ?>" size="12" tabindex="97" /></label>
