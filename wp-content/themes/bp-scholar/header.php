	...
	<body <?php body_class() ?>>
		...
		<div id="header">
			...
			if($logo_on == "no" && $square_logo == "yes"){
				...
				<h1 class="square-header"><a href="<?php echo home_url(); ?>" title="<?php _e( 'Home', 'bp-scholar' ) ?>"><?php echo ( $site_title ) ? $site_title : bloginfo( 'name' ); ?></a></h1>
			<?php
			}
			...
			?>
				<h1><a href="<?php echo home_url(); ?>" title="<?php _e( 'Home', 'bp-scholar' ) ?>"><?php echo stripslashes($site_title ? $site_title : bloginfo( 'name' )); ?></a></h1>
			<?php
			}
			...
			if($description_on == "yes"){
				?>
		<div class="description"><?php echo ( $description ) ? $description : bloginfo( 'description' ); ?></div>
			<?php
			}
			else{
			?>
