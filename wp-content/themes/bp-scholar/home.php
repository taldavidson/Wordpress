...
<?php
	...
	if ( $spotlight_category == 'Select a category:' )
		$spotlight_category = '';
			...
			<div id="content">
					...
					<div id="front-2col">
						<div id="front-maincolumn">
							<?php if ( $welcome_title || $welcome_message ): ?>
							<div class="content-box-outer" id="welcome_box">
									...
									<div class="content-box-inner">
										<div class="entry">
											<div class="entry-image">
												<span class="attach-post-image" style="height:100px;width:100px;display:block;background:url('<?php the_post_image_url($news_image_display); ?>') center center repeat">&nbsp;</span>
											</div>
											<?php the_excerpt(); ?>
								...
								<div class="content-box-inner">
									...
									<div class="entry">
										...
										<div class="entry-image-side">
											<span class="attach-post-image" style="height:60px;width:170px;display:block;background:url('<?php the_post_image_url($spotlight_image_display); ?>') center center repeat">&nbsp;</span>
										</div>
										<?php the_excerpt(); ?>
										<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('permalink to', 'bp-scholar');?><?php the_title_attribute(); ?>"><?php _e( 'Read more', 'bp-scholar' ) ?></a>
										<hr/>
