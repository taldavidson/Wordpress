			...
			if ( (isset($_POST['snapshot_blog_id_search'])) && (!empty($_POST['snapshot_blog_id_search'])) ) {
				...
				if (intval($snapshot_blog_id_search) != 0) {
					...
					if (is_subdomain_install()) {
						...
						$snapshot_blog_id_search = untrailingslashit($snapshot_blog_id_search);
						$snapshot_blog_id_search_path 	= "/". basename($snapshot_blog_id_search) ."/";
						$snapshot_blog_id_search_domain = dirname($snapshot_blog_id_search);
